...
function depthEqual(objA, objB, depth = 1) {
  if (objA === objB) {
    return true;
  }

  if (depth === 0 || typeof objA !== 'object' || objA === null || typeof objB !== 'object' || objB === null) {
  ...
  for (let i = 0; i < keysA.length; i++) {
    ...
    if (!bHasOwnProperty(aKey) || // recursively call depthEqual at the next level; depth 0 is === check
...
//# sourceMappingURL=depthEqual.js.map